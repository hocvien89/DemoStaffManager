                    ...
                    <form class="form-horizontal" id='form_validation'>
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="taskName" class="form-control" placeholder="Enter task name" v-validate="'required'"  v-bind:class="{'form-control': true, 'error': errors.has('task name') }" name="project name" ref="projectName">
                                    </div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="beginDate" class="form-control datepicker" placeholder="Enter date begin of task" name="begin date" v-validate="'required'" v-bind:class="{'form-control': true, 'error': errors.has('begin date') }">
                                    </div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="endDate" class="form-control datepicker" placeholder="Enter date end of task" name="end date" v-validate="'required'" v-bind:class="{'form-control': true, 'error': errors.has('end date') }">
                                    </div>
...
export default {
  ...
  methods: {
    RegisterTask() {
        ...
        this.dataBackEnd.begin_date = this.formatDateBackEnd($("#beginDate").val());
      ...
      axios({
        ...
        headers: { "content-type": "application/json" }
         ...
         result => {
          ...
          this.formatForm();
          this.$router.push({name: 'TaskList', params: {project_cd: this.project_cd }});
        },
        error => {
